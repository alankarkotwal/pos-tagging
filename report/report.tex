...
\section{Conclusion}
We have successfully trained and tested a POS tagger on a considerable sized dataset and have demonstrated its abilities to discern context as well as classify POS accurately. %Our implementation and trained POS tagger can be found \href{https://github.com/alankarkotwal/pos-tagging}{here}.
